...
class PaymentMethodData {
	...
	public function to_array(): array {
		...
		if ( is_string( $this->merchant_identifier ) && '' !== trim( $this->merchant_identifier )
			&& is_string( $this->merchant_identifier_type ) && '' !== trim( $this->merchant_identifier_type ) ) {
			$data['merchant_identifier']      = $this->merchant_identifier;
			$data['merchant_identifier_type'] = $this->merchant_identifier_type;
		}
