...
// These tests use a temporary stream as controlled input.
...
class SessionDataCollectorTest extends FraudProtectionUnitTestCase {
	 ...
	 */
	public function test_collect_limits_deep_event_by_node_count(): void {
	 ...
	 */
	public function test_collect_limits_recursive_event_by_node_count(): void {
		$event_data         = array();
