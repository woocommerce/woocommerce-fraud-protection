...
mkdir( $tmp );
mkdir( $tmp . '/src/Internal/FraudProtection', 0777, true );
copy( dirname( __DIR__, 4 ) . '/woocommerce-fraud-protection.php', $tmp . '/woocommerce-fraud-protection.php' );
copy( dirname( __DIR__, 4 ) . '/src/Internal/FraudProtection/PluginInitializer.php', $tmp . '/src/Internal/FraudProtection/PluginInitializer.php' );
